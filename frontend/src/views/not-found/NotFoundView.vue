    ...
    <VerticalLayout>
        <section class="not-found">
            <div class="not-found__container">
                ...
                <p class="not-found__subtitle">Что-то произошло, но пока не понятно, что именно</p>
                <video class="not-found__media" controls autoplay muted loop playsinline>
                    <source src="/videos/404.mp4" type="video/mp4" />
                </video>
                <router-link class="not-found__button" to="/">
                    <span class="not-found__button-text">На главную</span>
                    <span class="not-found__button-icon"><TheSvgSprite type="arrow" :size="24" /></span>
                </router-link>
            </div>
        </section>
    </VerticalLayout>
